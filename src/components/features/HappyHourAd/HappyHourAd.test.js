...
describe('Component HappyHourAd', () => {
  ...
  const checkDescriptionAtTime = (time, expectedDescription) => {
    it(`should show correct at ${time}`, () => {
      ...
      const component = shallow(<HappyHourAd promoDescription={expectedDescription} />,
      );
  ...
  describe('Component HappyHourAd with mocked Date and delay', () => {
    checkDescriptionAfterTimeAroundHappyHours('11:59:58', 2 , mockProps.promoDescription, );
    checkDescriptionAfterTimeAroundHappyHours('11:59:00', 60, mockProps.promoDescription, );
    checkDescriptionAfterTimeAroundHappyHours('11:00:00', 60 * 60, mockProps.promoDescription, );
  });
});
